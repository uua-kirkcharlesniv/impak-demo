                                ...
                                <div class="space-y-3 mb-8">
                                    <label class="relative block cursor-pointer">
                                        ...
                                        <div class="flex items-center bg-white text-sm font-medium text-slate-800 p-4 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                                            <i class="fa-solid fa-square-poll-vertical fa-2x w-7 h-7 shrink-0 fill-current mr-4 text-indigo-400" style=""></i>
                                            <span>I want to create surveys</span>
                                        </div>
                                    ...
                                    <label class="relative block cursor-pointer">
                                        ...
                                        <div class="flex items-center bg-white text-sm font-medium text-slate-800 p-4 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                                            <i class="fa-solid fa-people-group fa-2x w-7 h-7 shrink-0 fill-current mr-4 text-indigo-500" style=""></i>
                                            <span>I want to connect with community</span>
                                        </div>
                                        <div class="absolute inset-0 border-2 border-transparent peer-checked:border-indigo-400 rounded pointer-events-none" aria-hidden="true"></div>
                                    </label>
                                    <label class="relative block cursor-pointer">
                                        <input type="radio" name="radio-buttons" class="peer sr-only" />
                                        <div class="flex items-center bg-white text-sm font-medium text-slate-800 p-4 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                                            <i class="fa-solid fa-rocket fa-2x w-7 h-7 shrink-0 fill-current mr-4 text-indigo-600" style=""></i>
...
<?php endif; ?>
<?php /**PATH D:\laravel\mosiac\resources\views/pages/onboarding-01.blade.php ENDPATH**/ ?>