    ...
    <div class="mb-2">
        <ul class="inline-flex flex-wrap text-sm font-medium">
            <li class="flex items-center">
                <a class="text-slate-500 hover:text-indigo-500" href="<?php echo e(route('forum')); ?>">Home</a>
                        ...
                        <div class="flex flex-wrap text-xs">
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                <a class="block mr-2" href="#0">
                                    <img class="rounded-full" src="<?php echo e(asset('images/user-28-02.jpg')); ?>" width="24" height="24" alt="User 02" />
                                </a>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap text-xs">
                                    <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                        <a class="block mr-2" href="#0">
                                            <img class="rounded-full" src="<?php echo e(asset('images/user-28-05.jpg')); ?>" width="24" height="24" alt="User 05" />
                                        </a>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap text-xs">
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                <a class="block mr-2" href="#0">
                                    <img class="rounded-full" src="<?php echo e(asset('images/user-28-01.jpg')); ?>" width="24" height="24" alt="User 01" />
                                </a>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap text-xs">
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                <a class="block mr-2" href="#0">
                                    <img class="rounded-full" src="<?php echo e(asset('images/user-28-09.jpg')); ?>" width="24" height="24" alt="User 09" />
                                </a>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap text-xs">
                            <div class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                                <a class="block mr-2" href="#0">
                                    <img class="rounded-full" src="<?php echo e(asset('images/user-28-10.jpg')); ?>" width="24" height="24" alt="User 10" />
                                </a>
...
</article><?php /**PATH /Volumes/240/valet-sites/mosiac/resources/views/components/community/forum-entry.blade.php ENDPATH**/ ?>