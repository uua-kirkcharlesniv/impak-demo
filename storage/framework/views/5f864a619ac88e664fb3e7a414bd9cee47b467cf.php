                            ...
                            <div class="max-w-md mx-auto w-full">
                                <div class="relative">
                                    ...
                                    <ul class="relative flex justify-between w-full">
                                        ...
                                        <li>
                                            <a class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-indigo-500 text-white" href="<?php echo e(route('onboarding-02')); ?>">2</a>
                                        </li>
                                        <li>
                                            <a class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-indigo-500 text-white" href="<?php echo e(route('onboarding-03')); ?>">3</a>
                                        </li>
                                        <li>
                                            <a class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-indigo-500 text-white" href="<?php echo e(route('onboarding-04')); ?>">4</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="px-4 py-8">
                        <div class="max-w-md mx-auto">
                            ...
                            <div class="text-center">
                                ...
                                <a class="btn bg-indigo-500 hover:bg-indigo-600 text-white" href="<?php echo e(route('dashboard')); ?>">Go To Dashboard -&gt;</a>
                            </div>
...
<?php endif; ?>
<?php /**PATH /Volumes/240/valet-sites/mosiac/resources/views/pages/onboarding-04.blade.php ENDPATH**/ ?>