                        ...
                        <div class="max-w-md mx-auto">
                            ...
                            <form>
                                ...
                                <div class="flex items-center justify-between">
                                    <a class="text-sm underline hover:no-underline" href="<?php echo e(route('onboarding-02')); ?>">&lt;- Back</a>
                                    <a class="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-auto" href="<?php echo e(route('onboarding-04')); ?>">Next Step -&gt;</a>
                                </div>
                            </form>
...
<?php endif; ?>
<?php /**PATH /Volumes/240/valet-sites/mosiac/resources/views/pages/onboarding-03.blade.php ENDPATH**/ ?>