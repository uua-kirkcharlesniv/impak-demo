    ...
    <main class="grow">
        ...
        <section class="relative">
            ...
            <div class="absolute inset-0">
                <img class="w-full h-full object-cover" src="./images/about-hero.jpg" width="1440" height="394"
                    alt="About" />
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 relative">
                <div class="pt-32 pb-12 md:pt-40 md:pb-20">
                    <div class="max-w-3xl mx-auto text-center">
                        ...
                        <p class="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">Developers are trusted
                            to create an engaging experience for their companies, so we build tools to help them.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6">
                <div class="max-w-3xl mx-auto">
                    <div class="relative w-full h-0 pb-3/4">
                        <figure class="absolute h-auto" style="top:45%;width: 41.67%;max-width: 320px;"
                            data-aos="fade-right">
                            <img src="./images/team-mosaic-02.jpg" width="320" height="240" alt="Team mosaic 02" />
                        </figure>
                        <figure class="relative mx-auto h-auto" style="width: 78.13%;max-width: 600px;" data-aos="fade-down"
                            data-aos-delay="100">
                            <img src="./images/team-mosaic-01.jpg" width="600" height="338" alt="Team mosaic 01" />
                        </figure>
                        <figure class="absolute h-auto" style="top: 8.5%;right: 0;width: 32.55%;max-width: 250px;"
                            data-aos="fade-left" data-aos-delay="200">
                            <img src="./images/team-mosaic-03.jpg" width="250" height="188" alt="Team mosaic 03" />
                        </figure>
                        <figure class="absolute h-auto" style="bottom: 0;right: 20%;width: 25.52%;max-width: 196px;"
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6">
                <div class="py-12 md:py-20">
                    ...
                    <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                        ...
                        <p class="text-xl text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                    ...
                    <div class="max-w-3xl mx-auto -my-4 md:-my-6" data-aos-id-timeline>
                        ...
                        <!-- 1st item -->
                        <div class="relative py-4 md:py-6 pl-24" data-aos="fade-up"
                            ...
                            <div class="pl-2">
                                ...
                                <div class="flex items-center mb-3">
                                    <div
                                        ...
                                        2016</div>
                                    <div class="absolute left-0 h-full px-px bg-gray-800 ml-20 self-start transform -translate-x-1/2 translate-y-3"
                                        aria-hidden="true"></div>
                                    <div class="absolute left-0 w-2 h-2 bg-purple-600 border-4 box-content border-gray-900 rounded-full ml-20 transform -translate-x-1/2"
                                        aria-hidden="true"></div>
                                    <h4 class="h4">Impak was founded in Manila, Philippines 🇵🇭</h4>
                                </div>
                                <p class="text-lg text-gray-400">Pretium lectus quam id leo. Urna et pharetra pharetra massa
                                    massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</p>
                            </div>
                        </div>

                        <!-- 2nd item -->
                        <div class="relative py-4 md:py-6 pl-24" data-aos="fade-up" data-aos-delay="200"
                            data-aos-anchor="[data-aos-id-timeline]">
                            <div class="pl-2">
                                ...
                                <div class="flex items-center mb-3">
                                    ...
                                    <div class="absolute left-0 w-2 h-2 bg-purple-600 border-4 box-content border-gray-900 rounded-full ml-20 transform -translate-x-1/2"
                                        aria-hidden="true"></div>
                                    <h4 class="h4">Launched the first Impak Advanced plan</h4>
                                </div>
                                <p class="text-lg text-gray-400">Pretium lectus quam id leo. Urna et pharetra pharetra massa
                                    massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</p>
                            </div>
                        ...
                        <!-- 3rd item -->
                        <div class="relative py-4 md:py-6 pl-24" data-aos="fade-up" data-aos-delay="400"
                            data-aos-anchor="[data-aos-id-timeline]">
                            <div class="pl-2">
                        ...
                        <!-- 4th item -->
                        <div class="relative py-4 md:py-6 pl-24" data-aos="fade-up" data-aos-delay="600"
                            data-aos-anchor="[data-aos-id-timeline]">
                            <div class="pl-2">
                                ...
                                <p class="text-lg text-gray-400">Pretium lectus quam id leo. Urna et pharetra pharetra
                                    massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</p>
                            </div>
                        </div>
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6">
                <div class="py-12 md:py-20 border-t border-gray-800">
                    ...
                    <div class="sm:flex sm:flex-wrap sm:justify-center -my-4 sm:-my-8 sm:-mx-3" data-aos-id-team>
                        ...
                        <!-- 1st member -->
                        <div class="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up"
                            data-aos-anchor="[data-aos-id-team]">
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-4" src="./images/team-member-01.jpg" width="120"
                                    height="120" alt="Team member 01" />
                                <h4 class="text-xl font-medium mb-1">Lara Lamprecht</h4>
                                <div class="text-gray-500 mb-1">CEO & Co-founder</div>
                                <a class="block text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                                    href="#0">@laraamprecht</a>
                            </div>
                        </div>
                        ...
                        <div class="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-4" src="./images/team-member-02.jpg" width="120"
                                    height="120" alt="Team member 02" />
                        ...
                        <div class="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-4" src="./images/team-member-03.jpg" width="120"
                                    height="120" alt="Team member 03" />
                                <h4 class="text-xl font-medium mb-1">Greg Sebastian</h4>
                                <div class="text-gray-500 mb-1">Head of Design</div>
                                <a class="block text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                                    href="#0">@mr_sebastian</a>
                            </div>
                        </div>
                        ...
                        <div class="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-4" src="./images/team-member-04.jpg" width="120"
                                    height="120" alt="Team member 04" />
                                <h4 class="text-xl font-medium mb-1">Timothy Chandran</h4>
                                <div class="text-gray-500 mb-1">Product Executive</div>
                                <a class="block text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                                    href="#0">@timothychandran</a>
                            </div>
                        </div>
                        ...
                        <div class="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-4" src="./images/team-member-05.jpg" width="120"
                                    height="120" alt="Team member 05" />
                                <h4 class="text-xl font-medium mb-1">Dominik Prasad</h4>
                                <div class="text-gray-500 mb-1">Backend Lead</div>
                                <a class="block text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                                    href="#0">@dominikprasad</a>
                            </div>
                        </div>
                        ...
                        <div class="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-4" src="./images/team-member-06.jpg" width="120"
                                    height="120" alt="Team member 06" />
                        ...
                        <div class="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-4" src="./images/team-member-07.jpg" width="120"
                                    height="120" alt="Team member 07" />
                                <h4 class="text-xl font-medium mb-1">Quentin Renvoye</h4>
                                <div class="text-gray-500 mb-1">Product Designer</div>
                                <a class="block text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                                    href="#0">@quentinrenvoye</a>
                            </div>
                        </div>
                        ...
                        <div class="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-4" src="./images/team-member-08.jpg" width="120"
                                    height="120" alt="Team member 08" />
                                <h4 class="text-xl font-medium mb-1">Alyssa Chuzeville</h4>
                                <div class="text-gray-500 mb-1">Community Lead</div>
                                <a class="block text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                                    href="#0">@hello_chuzeville</a>
                            </div>
                        </div>
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6">
                <div class="py-12 md:py-20 border-t border-gray-800">
                    ...
                    <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16" data-aos-id-testimonialcar>
                        <h2 class="h2 mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-testimonialcar]">Join the
                            Impak team</h2>
                        <p class="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200"
                            data-aos-anchor="[data-aos-id-testimonialcar]">Vitae aliquet nec ullamcorper sit amet risus
                            nullam eget felis semper quis lectus nulla at volutpat diam ut venenatis tellus in ornare.</p>
                    </div>
                    ...
                    <div class="max-w-3xl mx-auto pb-16">
                        <ul
                            ...
                            <li class="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="400"
                                data-aos-anchor="[data-aos-id-testimonialcar]">
                                <svg class="w-6 h-6 mr-3 shrink-0" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle class="fill-current text-green-500" cx="12" cy="12"
                                        r="12" />
                            ...
                            <li class="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="500"
                                data-aos-anchor="[data-aos-id-testimonialcar]">
                                <svg class="w-6 h-6 mr-3 shrink-0" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle class="fill-current text-green-500" cx="12" cy="12"
                            ...
                            <li class="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="600"
                                data-aos-anchor="[data-aos-id-testimonialcar]">
                                <svg class="w-6 h-6 mr-3 shrink-0" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle class="fill-current text-green-500" cx="12" cy="12"
                            ...
                            <li class="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="700"
                                data-aos-anchor="[data-aos-id-testimonialcar]">
                                <svg class="w-6 h-6 mr-3 shrink-0" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle class="fill-current text-green-500" cx="12" cy="12"
                            ...
                            <li class="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="800"
                                data-aos-anchor="[data-aos-id-testimonialcar]">
                                <svg class="w-6 h-6 mr-3 shrink-0" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle class="fill-current text-green-500" cx="12" cy="12"
                    ...
                    <div class="max-w-2xl mx-auto">
                        ...
                        <!-- Carousel -->
                        <div x-data="carousel" class="mt-6">

                            <!-- Testimonials -->
                            <div class="relative flex items-start" x-ref="testimonials">
                                ...
                                <template x-for="(item, index) in items" :key="index">
                                    <div x-show="active === index" class="text-center"
                                        x-transition:enter="transition ease-in-out duration-500 transform order-first"
                                        x-transition:enter-start="opacity-0 scale-98"
                                        x-transition:enter-end="opacity-100 scale-100"
                                        x-transition:leave="transition ease-out duration-300 transform absolute"
                                        x-transition:leave-start="opacity-100 scale-100"
                                        x-transition:leave-end="opacity-0 scale-98">
                                        <div class="relative inline-flex flex-col justify-center mb-4">
                                            <img class="rounded-full" :src="'images/' + item.img" width="56"
                                                height="56" :alt="item.alt" />
                                            <svg class="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-purple-600"
                                        ...
                                        <blockquote class="text-lg text-gray-400" x-text="item.quote"></blockquote>
                                        <div class="text-gray-700 font-medium mt-3">
                                            <cite class="text-gray-200 not-italic" x-text="item.name"></cite> / <span
                            ...
                            document.addEventListener('alpine:init', () => {
                                Alpine.data('carousel', () => ({
                                    ...
                                    items: [{
                                            ...
                                            alt: 'Testimonial 01',
                                            quote: '“ I feel grateful that Impak pushed me to expand my horizons and strive to accomplish more, not only in my career but in education as well.“',
                                            name: 'Darya Semenova',
                                        ...
                                        },
                                        {
                                            ...
                                            alt: 'Testimonial 02',
                                            quote: '“ Not only in my career but in education as well, I feel grateful that Impak pushed me to expand my horizons and strive to accomplish more.“',
                                            name: 'Greg Sebastian',
                                            role: 'Head of Design'
                                        },
                                        {
                                    ...
                                    init() {
                                        if (this.autorotate) {
                                            this.autorotateInterval = setInterval(() => {
                                                this.active = this.active + 1 === this.items.length ? 0 : this
                                                    .active + 1
                                    ...
                                    heightFix() {
                                        this.$nextTick(() => {
                                            this.$refs.testimonials.style.height = this.$refs.testimonials.children[
                                                this.active + 1].offsetHeight + 'px'
                                        })
                                    }
                                }))
                            })
                    ...
                    <div class="-my-3" data-aos-id-career>
                        ...
                        <div class="py-3" data-aos="fade-up" data-aos-anchor="[data-aos-id-career]">
                            <div class="pb-6 border-b border-gray-800">
                                <div class="mb-2">
                                    <a class="flex justify-between items-center text-xl font-bold text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                                        href="#0">
                                        <span>Lead Product Designer</span>
                                        <svg class="stroke-current shrink-0 ml-2" width="24" height="24"
                                            xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="text-lg text-gray-400 mb-3">
                                    You'll be joing the Experience Design Team as a Lead Product Designer. You'll interface
                                    daily with developers - encouraging and advancing best practices in software.
                                </div>
                                <div class="text-gray-400 flex flex-wrap items-center">
                                    <div class="inline-flex items-center">
                                        <svg class="mr-2 shrink-0" vidth="14" height="17" viewBox="0 0 14 17"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path class="fill-current text-gray-300"
                                    ...
                                    <div class="inline-flex items-center">
                                        <svg class="mr-2 shrink-0" vidth="14" height="16" viewBox="0 0 14 16"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path class="fill-current text-gray-300"
                        ...
                        <!-- 3rd Item -->
                        <div class="py-3" data-aos="fade-up" data-aos-delay="400"
                            data-aos-anchor="[data-aos-id-career]">
                            <div class="pb-6 border-b border-gray-800">
                                <div class="mb-2">
                                    <a class="flex justify-between items-center text-xl font-bold text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6">
                <div class="py-12 md:py-20 border-t border-gray-800">
                    ...
                    <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                        <h1 class="h2 mb-4">Our customers span the globe</h1>
                        <p class="text-xl text-gray-400">Duis aute irure dolor in reprehenderit in voluptate velit esse
                    ...
                    <div class="grid gap-2 grid-cols-2 md:grid-cols-4" data-aos-id-clients>
                        ...
                        <!-- Item -->
                        <div class="flex items-center justify-center h-24 border border-gray-700 p-2" data-aos="fade-up"
                            data-aos-anchor="[data-aos-id-clients]">
                            <svg class="max-w-full fill-current text-gray-500" width="124" height="24"
                                viewBox="0 0 124 24" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <!-- Item -->
                        <div class="flex items-center justify-center h-24 border border-gray-700 p-2" data-aos="fade-up"
                            data-aos-delay="100" data-aos-anchor="[data-aos-id-clients]">
                            <svg class="max-w-full fill-current text-gray-500" width="83" height="30"
                                viewBox="0 0 83 30" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <!-- Item -->
                        <div class="flex items-center justify-center h-24 border border-gray-700 p-2" data-aos="fade-up"
                            data-aos-delay="200" data-aos-anchor="[data-aos-id-clients]">
                            <svg class="max-w-full fill-current text-gray-500" width="125" height="39"
                                viewBox="0 0 125 39" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <!-- Item -->
                        <div class="flex items-center justify-center h-24 border border-gray-700 p-2" data-aos="fade-up"
                            data-aos-delay="300" data-aos-anchor="[data-aos-id-clients]">
                            <svg class="max-w-full fill-current text-gray-500" width="113" height="30"
                                viewBox="0 0 113 30" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="relative flex flex-col lg:flex-row justify-between items-center">
                        ...
                        <form class="w-full lg:w-1/2">
                            <div
                                ...
                                <input type="email"
                                    class="w-full appearance-none bg-purple-700 border border-purple-500 focus:border-purple-300 rounded-sm px-4 py-3 mb-2 sm:mb-0 sm:mr-2 text-white placeholder-purple-400"
                                    placeholder="Your best email…" aria-label="Your best email…" />
                                <a class="btn text-purple-600 bg-purple-100 hover:bg-white shadow"
                                    href="#0">Subscribe</a>
                            </div>
                            <!-- Success message -->
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\mosiac\resources\views/home/about.blade.php ENDPATH**/ ?>