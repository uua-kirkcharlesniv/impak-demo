...
<?php $__env->startSection('content'); ?>
    <div class="grow border-b border-gray-800">
                    ...
                    <main class="md:flex-auto md:pl-10 order-1" data-aos="fade-up">
                        ...
                        <div x-show="page === '1'">
                            <div class="mb-8">
                                ...
                                <p class="text-gray-400">Last updated - <span class="text-purple-600">June 30, 2020</span>
                                </p>
                            </div>
                            <ul class="-my-4">
                                <li class="py-4">
                                    <h4 class="text-xl font-medium mb-2">How can I use Impak without registration?</h4>
                                    <p class="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim
                                        lobortis scelerisque fermentum.</p>
                                </li>
                                <li class="py-4">
                                    <h4 class="text-xl font-medium mb-2">Can I import my sitemap to Impak?</h4>
                                    <p class="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim
                                        lobortis scelerisque fermentum.</p>
                                </li>
                                <li class="py-4">
                                    <h4 class="text-xl font-medium mb-2">How can I switch my subscription between essential,
                                        and premium plans?</h4>
                                    <p class="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim
                                        lobortis scelerisque fermentum.</p>
                                </li>
                                ...
                                <li class="py-4">
                                    <h4 class="text-xl font-medium mb-2">Is there an additional discount when paid annually?
                                    </h4>
                                    <p class="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim
                                        lobortis scelerisque fermentum.</p>
                                ...
                                <li class="py-4">
                                    <h4 class="text-xl font-medium mb-2">What happens if I don’t renew my license after one
                                        year?</h4>
                                    <p class="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim
                                        lobortis scelerisque fermentum.</p>
                        ...
                        <div x-show="page === '2'">
                            <div class="mb-8">
                                <h2 class="h2 mb-4">What is Impak</h2>
                                <p class="text-gray-400">Last updated - <span class="text-purple-600">June 30, 2020</span>
                                </p>
                            </div>
                            <ul class="-my-4">
                        ...
                        <!-- Impak plan’s features -->
                        <div x-show="page === '3'">
                            <div class="mb-8">
                                <h2 class="h2 mb-4">Impak plan’s features</h2>
                                <p class="text-gray-400">Last updated - <span class="text-purple-600">June 30, 2020</span>
                                </p>
                            </div>
                            <ul class="-my-4">
                                ...
                                <li class="py-4">
                                    <h4 class="text-xl font-medium mb-2">Is there an additional discount when paid
                                        annually?</h4>
                                    <p class="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim
                                        lobortis scelerisque fermentum.</p>
                        ...
                        <div x-show="page === '4'">
                            ...
                            <ul class="-my-4">
                                ...
                                <li class="py-4">
                                    <h4 class="text-xl font-medium mb-2">How can I switch my subscription between
                                        essential, and premium plans?</h4>
                                    <p class="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim
                                        lobortis scelerisque fermentum.</p>
                                </li>
                        ...
                        <nav>
                            <ul>
                                <li class="py-2 border-b border-gray-800">
                                    <a :class="{ 'text-purple-600': page === '1' }"
                                        class="flex items-center px-3 group text-gray-400 hover:text-purple-600 transition duration-150 ease-in-out"
                                        href="#0" @click.prevent="page = '1'">
                                        <span>Frequently Asked Questions</span>
                                        <svg class="w-3 h-3 fill-current shrink-0 ml-2 opacity-0 group-hover:opacity-100 group-hover:text-purple-600 group-hover:translate-x-1 transition duration-150 ease-in-out transform"
                                ...
                                <li class="py-2 border-b border-gray-800">
                                    <a :class="{ 'text-purple-600': page === '2' }"
                                        class="flex items-center px-3 group text-gray-400 hover:text-purple-600 transition duration-150 ease-in-out"
                                        href="#0" @click.prevent="page = '2'">
                                        <span>What is Impak</span>
                                        <svg class="w-3 h-3 fill-current shrink-0 ml-2 opacity-0 group-hover:opacity-100 group-hover:text-purple-600 group-hover:translate-x-1 transition duration-150 ease-in-out transform"
                                            viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M11.707 5.293L7 .586 5.586 2l3 3H0v2h8.586l-3 3L7 11.414l4.707-4.707a1 1 0 000-1.414z" />
                                ...
                                <li class="py-2 border-b border-gray-800">
                                    <a :class="{ 'text-purple-600': page === '3' }"
                                        class="flex items-center px-3 group text-gray-400 hover:text-purple-600 transition duration-150 ease-in-out"
                                        href="#0" @click.prevent="page = '3'">
                                        <span>Impak plan’s features</span>
                                        <svg class="w-3 h-3 fill-current shrink-0 ml-2 opacity-0 group-hover:opacity-100 group-hover:text-purple-600 group-hover:translate-x-1 transition duration-150 ease-in-out transform"
                                            viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M11.707 5.293L7 .586 5.586 2l3 3H0v2h8.586l-3 3L7 11.414l4.707-4.707a1 1 0 000-1.414z" />
                                ...
                                <li class="py-2 border-b border-gray-800">
                                    <a :class="{ 'text-purple-600': page === '4' }"
                                        class="flex items-center px-3 group text-gray-400 hover:text-purple-600 transition duration-150 ease-in-out"
                                        href="#0" @click.prevent="page = '4'">
                                ...
                                <li class="py-2 border-b border-gray-800">
                                    <a :class="{ 'text-purple-600': page === '5' }"
                                        class="flex items-center px-3 group text-gray-400 hover:text-purple-600 transition duration-150 ease-in-out"
                                        href="#0" @click.prevent="page = '5'">
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\mosiac\resources\views/home/help.blade.php ENDPATH**/ ?>