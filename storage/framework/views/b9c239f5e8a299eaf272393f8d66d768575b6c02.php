            ...
            <div class="relative inline-flex" x-data="{ open: false }">
                <button class="inline-flex justify-center items-center group" aria-haspopup="true" @click.prevent="open = !open" :aria-expanded="open">
                    <div class="flex items-center truncate">
                        <span class="truncate font-medium text-indigo-500 group-hover:text-indigo-600"><?php echo e(\Carbon\Carbon::now()->format('F')); ?></span>
                ...
                >
                    <ul>
                        <li>
                            <a class="font-medium text-sm text-slate-600 hover:text-slate-800 flex items-center py-1 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false"><?php echo e(\Carbon\Carbon::now()->subMonth(1)->format('F')); ?></a>
                        </li>
                        <li>
                            <a class="font-medium text-sm text-slate-600 hover:text-slate-800 flex items-center py-1 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false"><?php echo e(\Carbon\Carbon::now()->subMonth(2)->format('F')); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\laravel\mosiac\resources\views/pages/finance/transaction-details.blade.php ENDPATH**/ ?>