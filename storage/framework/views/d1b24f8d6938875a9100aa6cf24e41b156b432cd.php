            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6">
                <div class="pt-32 pb-12 md:pt-40 md:pb-20">
                    ...
                    <div class="max-w-3xl mx-auto text-center pb-12">
                        ...
                        <p class="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">Get the Impak plan that
                            fits your needs at a special introductory price.</p>
                    </div>
                    ...
                    <div x-data="pricingSwitch">
                        ...
                        <div class="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
                            ...
                            <!-- Pricing table 1 -->
                            <div class="relative flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up"
                                data-aos-delay="700">
                                <div class="mb-4 pb-4 border-b border-gray-700">
                                    ...
                                    <div class="text-gray-400">Better insights for growing businesses that want more
                                        customers.</div>
                                </div>
                                ...
                                <div class="border border-gray-700 p-3 mt-6">
                                    <a class="btn-sm text-white bg-purple-600 hover:bg-purple-700 w-full"
                        ...
                        <div
                            ...
                            <div class="font-medium text-lg text-center lg:text-left mb-4 lg:mb-0">Expecting more than 1000
                                Active End Users?</div>
                            <div>
                                <a class="btn-sm text-white bg-purple-600 hover:bg-purple-700" href="#0">Contact
                                    us</a>
                            </div>
                        </div>
                ...
                <div class="py-12 md:py-20 border-t border-gray-800 lg:border-0 lg:pt-0">
                    ...
                    <ul class="grid gap-8 md:grid-cols-2 xl:gap-x-16 lg:gap-y-12">
                        <li>
                            ...
                            <p class="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                                do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis
                ...
                <div class="py-12 md:py-20 border-t border-gray-800">
                    ...
                    <div class="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
                        ...
                        <div class="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
                            ...
                            <blockquote class="text-lg text-gray-400 grow">— Impak lets me quickly get the insights I
                                care about so that I can focus on my productive work. I've had Impak for about 24 hours
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 relative">
                <div class="pt-12 md:pt-20 border-t border-b border-gray-800">
                    <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16" data-aos-id-cta>
                        ...
                        <!-- Section header -->
                        <h1 class="h2 mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-cta]">Ready to create better
                            products?</h1>
                        <p class="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200"
                            data-aos-anchor="[data-aos-id-cta]">Excepteur sint occaecat cupidatat non proident, sunt in
                        ...
                        <div class="flex justify-center mb-8" data-aos="fade-up" data-aos-delay="400"
                            ...
                            <a class="btn text-white bg-purple-600 hover:bg-purple-700" href="#0">Start free
                                trial</a>
                        </div>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\mosiac\resources\views/home/pricing.blade.php ENDPATH**/ ?>