...
<?php $component->withAttributes([]); ?>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
                <div class="mb-6">
                    <a class="btn-sm px-3 bg-white border-slate-200 hover:border-slate-300 text-slate-600" href="<?php echo e(route('community.events')); ?>">
                ...
                <div class="space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0 mb-6">
                    ...
                    <div class="flex items-center sm:mr-4">
                        <a class="block mr-2 shrink-0" href="#0">
                            <img class="rounded-full" src="<?php echo e(asset('images/user-32-07.jpg')); ?>" width="32" height="32" alt="User 04" />
                        </a>
                ...
                <!-- Image -->
                <figure class="mb-6">
                    <img class="w-full rounded-sm" src="<?php echo e(asset('images/meetup-image.jpg')); ?>" width="640" height="360" alt="Meetup" />
                </figure>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-4 my-6">
                        <a class="block" href="#0">
                            <img class="w-full rounded-sm" src="<?php echo e(asset('images/meetup-photo-01.jpg')); ?>" width="203" height="152" alt="Meetup photo 01" />
                        </a>
                        <a class="block" href="#0">
                            <img class="w-full rounded-sm" src="<?php echo e(asset('images/meetup-photo-02.jpg')); ?>" width="203" height="152" alt="Meetup photo 02" />
                        </a>
                        <a class="block" href="#0">
                            <img class="w-full rounded-sm" src="<?php echo e(asset('images/meetup-photo-03.jpg')); ?>" width="203" height="152" alt="Meetup photo 03" />
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="space-y-5 my-6">
                        ...
                        <li class="flex items-start">
                            <a class="block mr-3 shrink-0" href="#0">
                                <img class="rounded-full" src="<?php echo e(asset('images/user-32-07.jpg')); ?>" width="32" height="32" alt="User 07" />
                            </a>
                            <div class="grow">
                        ...
                        <li class="flex items-start">
                            <a class="block mr-3 shrink-0" href="#0">
                                <img class="rounded-full" src="<?php echo e(asset('images/user-32-08.jpg')); ?>" width="32" height="32" alt="User 08" />
                            </a>
                            <div class="grow">
                        ...
                        <li class="flex items-start">
                            <a class="block mr-3 shrink-0" href="#0">
                                <img class="rounded-full" src="<?php echo e(asset('images/user-32-02.jpg')); ?>" width="32" height="32" alt="User 02" />
                            </a>
                            <div class="grow">
...
<?php endif; ?>
<?php /**PATH /Volumes/240/valet-sites/mosiac/resources/views/pages/community/meetups-post.blade.php ENDPATH**/ ?>