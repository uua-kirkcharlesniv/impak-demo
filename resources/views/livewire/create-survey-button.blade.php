    ...
    <div id="feedback-modal"
        ...
        <form wire:submit.prevent="submit">
            <div class="bg-white rounded shadow-lg overflow-auto max-w-3xl w-full max-h-full"
                ...
                <!-- Modal content -->
                <div class="px-5 py-4">
                    <div data-v-848cd501="" class="sm:flex sm:flex-col sm:items-start">
                        <div data-v-848cd501="" class="flex w-full justify-center mb-4">
                            <div data-v-848cd501=""
                                class="w-14 h-14 rounded-full flex justify-center items-center bg-blue-100 text-blue-600">
                        ...
                        <div data-v-848cd501="" class="mt-3 text-center sm:mt-0 w-full">
                            <h2 data-v-848cd501="" class="text-2xl font-semibold text-center text-gray-900">Choose a
                                base for your form</h2>
                        </div>
                    </div>
                    <div class="mt-2 w-full">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                            <div
                                ...
                                <div class="p-4"><i
                                        class="fa-regular fa-face-grin-stars w-8 text-blue-500 fa-2xl"></i></div>
