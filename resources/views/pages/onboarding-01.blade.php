                                ...
                                <div class="space-y-3 mb-8">
                                    <label class="relative block cursor-pointer">
                                        ...
                                        <div
                                            ...
                                            <i class="fa-solid fa-square-poll-vertical fa-2x w-7 h-7 shrink-0 fill-current mr-4 text-indigo-400"
                                                style=""></i>
                                            <span>I want to use pre-built frameworks for my company</span>
                                        </div>
                                    ...
                                    <label class="relative block cursor-pointer">
                                        ...
                                        <div
                                            class="flex items-center bg-white text-sm font-medium text-slate-800 p-4 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                                            <i class="fa-solid fa-people-group fa-2x w-7 h-7 shrink-0 fill-current mr-4 text-indigo-500"
                                                style=""></i>
                                    ...
                                    <label class="relative block cursor-pointer">
                                        ...
                                        <div
                                            class="flex items-center bg-white text-sm font-medium text-slate-800 p-4 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                                            <i class="fa-solid fa-rocket fa-2x w-7 h-7 shrink-0 fill-current mr-4 text-indigo-600"
                                                style=""></i>
