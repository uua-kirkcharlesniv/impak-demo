    ...
    <div class="flex flex-col h-full">
        ...
        <div class="grow p-5">
            ...
            <div class="relative">
                <div class="absolute top-0 right-0 inline-flex" x-data="{ open: false }">
                    ...
                    >
                        <ul>
                            <li>
                                <a class="font-medium text-sm text-slate-600 hover:text-slate-800 flex py-1 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">@if($index == 0) Demote @else Promote @endif</a>
                            </li>
                            <li>
            ...
            <header>                
                ...
                <div class="flex justify-center items-center"><span class="text-sm font-medium text-slate-400 -mt-0.5 mr-1">@if($index == 0) Team Leader @else Member @endif</span></div>
            </header>
            <!-- Bio -->
