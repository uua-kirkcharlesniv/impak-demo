        ...
        <div class="grow flex flex-col md:translate-x-0 duration-300 ease-in-out">
            ...
            <div class="relative h-56 bg-slate-200">
                <img class="object-cover h-full w-full" src="https://images.unsplash.com/photo-1560179707-f14e90ef3623" width="979" height="220" alt="Profile background" />
                <!-- Close button -->
                <button class="md:hidden absolute top-4 left-4 sm:left-6 text-white opacity-80 hover:opacity-100" @click.stop="profileSidebarOpen = !profileSidebarOpen" aria-controls="profile-sidebar" :aria-expanded="profileSidebarOpen">
                ...
                <div class="-mt-16 mb-6 sm:mb-3">
                    ...
                    <div class="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
                        ...
                        <div class="inline-flex -ml-1 -mt-1 mb-4 sm:mb-0">
                            <img class="rounded-full border-4 border-white" src="{{ $user->profile_photo_url }}" width="128" height="128" alt="Avatar" />
                        </div>
                        ...
                        <div class="flex space-x-2 sm:mb-2">
                            ...
                            <button class="p-1.5 shrink-0 rounded border border-green-600 hover:border-green-700 shadow-sm" wire:click="promote">
                                Promote
                            </button>
                            @endif
                            @endif
                            ...
                            <button class="p-1.5 shrink-0 rounded border border-green-400 hover:border-slate-300 shadow-sm" wire:click="reactivateUser">
                            ...
                            @else
                            <button class="p-1.5 shrink-0 rounded border border-slate-200 hover:border-slate-300 shadow-sm  text-xl text-red-700" wire:click="deleteDoAction('{{ Request::segment(2) }}')">
                                ...
                                <div class="bg-white p-4 border border-slate-200 rounded-sm shadow-sm">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex -space-x-3 -ml-0.5">
                                            ...
                                            <img class="rounded-full border-2 border-white box-content" src="{{ $member->profile_photo_url }}" width="24" height="24" alt="Avatar" />
                                            @endforeach
                                        </div>
                                        <!-- Link -->
                                        <div>
                                            <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="{{ route('community.departments.view', $department->id) }}">View
                                                -&gt;</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="grid xl:grid-cols-2 gap-4">
                                ...
                                <div class="bg-white p-4 border border-slate-200 rounded-sm shadow-sm">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <!-- Link -->
                                        <div>
                                            <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="{{ route('community.groups.view', $group->id) }}">View -&gt;</a>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
            ...
            {{-- <div class="text-sm">
                    ...
                    <div>{{ \Carbon\Carbon::parse($user->dob)->toFormattedDateString() }}
        </div>
        </div> --}}
        {{-- <div class="text-sm">
