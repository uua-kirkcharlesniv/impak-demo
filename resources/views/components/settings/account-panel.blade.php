            ...
            <form action="{{ route('updatePasswordWeb') }}" method="POST">
                ...
                <div class="mt-5">
                    <div class="w-1/3">
                        ...
                        <x-jet-input id="old_password" type="password" name="old_password" required />
                    </div>
                    <div class="w-1/3 mt-2">
                        <x-jet-label for="password" value="{{ __('Password') }}" />
                        <x-jet-input id="new_password" type="password" name="new_password" required />
                    </div>
                    <div class="w-1/3 mt-2">
                        <x-jet-label for="password" value="{{ __('Confirm Password') }}" />
                        <x-jet-input id="confirm_password" type="password" name="confirm_password" required />
                    </div>
