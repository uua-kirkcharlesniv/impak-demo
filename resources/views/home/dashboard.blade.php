                ...
                <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                    ...
                    <p class="text-xl text-gray-400" data-aos="fade-down" data-aos-delay="100">Not
                        ...
                        <form method="POST" action="{{ route('logoutCentral') }}">
                            @csrf
                            <div class="ml-1">
                                <button type="submit" class="text-xl text-indigo-500 hover:text-indigo-600 underline hover:no-underline">
                                    {{ __('Log Out') }}
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="rounded-lg bg-white border border-4 border-indigo-200">
                        ...
                        <div class="p-4 flex flex-col gap-8">
                            ...
                            <div class="flex flex-row justify-between border-slate-400">
                                ...
                                <a href="{{ url(route('redirect-user-to-tenant', ['globalUserId' => auth()->user()->global_id, 'tenant' => $tenant])) }}" class="btn text-white bg-purple-600">Open</a>
                            </div>
                            @endforeach
                ...
                <form class="max-w-xl mx-auto" action="{{ route('create-company') }}" method="POST">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-4">
                        <div class="w-full px-3">
                            ...
                            <input id="company" name="company" type="text" class="form-input w-full text-gray-300" placeholder="acme" required />
                        </div>
                    </div>
